...
%
%  [I,PT] = applibt.ui.findclosestpointclick(POINTLIST)
%    or 
%  [I,PT] = applibt.ui.findclosestpointclick(POINTLIST, SCALE)
%
...
% 
%  See also: applibt.data.findclosest, applibt.data.findclosestpoint
...
[i]=applibt.data.findclosestpoint(pointlist_use,clicked_pt_use);
