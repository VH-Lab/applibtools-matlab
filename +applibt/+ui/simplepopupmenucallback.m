...
% 
% applibt.ui.simplepopupmenucallback(CALLBACKLIST[, VALUE])
%
...
%    'callback','applibt.ui.simplepopupmenucallback({''func1'',''func2''});');
%
%  When Option 1 is chosen, 'func1' is called by EVAL, when Option 2
%  is chosen, 'func2' is called by EVAL.
%
%
%  See also: GCBO, SUBREF, EVAL, applibt.ui.genercallback
