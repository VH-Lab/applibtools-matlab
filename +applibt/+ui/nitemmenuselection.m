...
%
% [SELECTED, B, ERRORMSG] = applibt.ui.nitemmenuselection(POPUPMENU_HANDLE, ...)
%
...
%       'style','popup','string',names,'callback','applibt.ui.nitemmenuselection(gcbo);');
%   selected=applibt.ui.nitemmenuselection(findobj(fig,'tag','mymenu'),'value',[]);
...
order = applibt.data.sortorder(indexes(find(indexes)));
