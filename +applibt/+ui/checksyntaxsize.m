...
%  applibt.ui.checksyntaxsize - Checks syntax and size of uitools string arguments
%
%  [B,VALS] = applibt.ui.checksyntaxsize(THEFIG,TAGLIST,SIZELIST,[ERRORMSG, VARNAMELIST])
%
...
for i=1:length(taglist),
   ...
   if (~isempty(sizelist{i}))&(~applibt.data.eqlen(size(v),sizelist{i})),
      b=0;vals={};
      if errormessage,
