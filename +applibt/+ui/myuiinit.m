...
%
%   * indicates that the 'callback' field is set to 'applibt.ui.genercallback'
%   Horizontal alignment of 'txt' and 'edit' controls is set to 'center'
%   All backgrounds are set to 0.8*[1 1 1] except for 'edit', which
%   is set to [1 1 1]
%
%  See also: UICONTROL, applibt.ui.genercallback, ASSIGNIN

button.Units = 'pixels';
button.BackgroundColor = [0.8 0.8 0.8];
button.HorizontalAlignment = 'center';
button.Callback = 'applibt.ui.genercallback';
...
popup.callback = 'applibt.ui.genercallback';

checkbox = txt;
checkbox.Style = 'Checkbox';
checkbox.Callback = 'applibt.ui.genercallback';
