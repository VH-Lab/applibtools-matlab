...
%  [GOOD,ERRORMSG] = applibt.data.hasAllFields(VARIABLE,FIELDNAMES,FIELDSIZES)
%
...
%
%      [g,e]=applibt.data.hasAllFields(r,{'test1','test2'},{[1 1],[1 2]})
%               gives g = 1, e=''.
%      [g,e]=applibt.data.hasAllFields(s,{'test1','test2'},{[1 1],[1 2]})
