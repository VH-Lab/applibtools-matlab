...
%
%  STR = applibt.data.struct2str(THESTRUCT)
%
...
%
%   STR = applibt.data.struct2str(THESTRUCT, 'NAME1', VALUE1,...)
%
...
%                      
%
% See also: STRUCT2CHAR, CHAR2STRUCT, applibt.data.mlstr2var
%
...
for i=1:numel(thestruct),
	...
	for j=1:length(fn),
		...
		if ischar(value),
			valuestr = value;
		elseif applibt.data.isint(value),
