...
%
% PRETTY = applibt.data.prettyjson(JSON_ENCODED_OBJECT, [SPACESTOINDENTEACHLEVEL])
%
...
%      j = applibt.data.jsonencodenan(mystruct) % produces single line
%      j_pretty = applibt.data.prettyjson(j) % produces multiple lines
%
%      % or a single line:
%      j_pretty = applibt.data.prettyjson(applibt.data.jsonencodenan(mystruct))
