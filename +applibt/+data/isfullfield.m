...
%
% [B, VALUE] = applibt.data.isfullfield(A, FIELD)
%
...
%
% See also: applibt.data.fieldsearch 
%
% Example:
%     A = struct('a',struct('sub1',1,'sub2',2),'b',5);
%     [b,value] = applibt.data.isfullfield(A, 'a.sub1') % returns b==1 and value==1
%     [b2,value2] = applibt.data.isfullfield(A, 'a.sub3') % returns b==0 and value==[]
% 
