...
%
% H = applibt.data.hashmatlabvariable(D)
%
...
%     h = applibt.data.hashmatlabvariable(A) % generate a hash, a hexidecimal string
%     h2 = applibt.data.hashmatlabvariable(A,'algorithm','pm_hash/crc') % require Simulink/SimScape; returns uint32
% 
