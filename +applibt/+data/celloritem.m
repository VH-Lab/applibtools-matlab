...
%
%   ITEM = applibt.data.celloritem(VAR, [INDEX], [USEINDEXFORVAR])
%
...
%
%      for i=1:3, 
%           applibt.data.celloritem(mylist1,i),
%           applibt.data.celloritem(mylist2,i),
%      end;
%
%  Example 2: 
%     myotherlist1 = [1 2 3];
...
%
%     for i=1:3,
%           applibt.data.celloritem(myotherlist1,i,1),
%           applibt.data.celloritem(myotherlist2,i,1),
%     end
