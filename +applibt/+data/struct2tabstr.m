...
%
% S = applibt.data.struct2tabstr(A)
%
...
%
% See also: applibt.file.loadStructArray, applibt.file.saveStructArray, applibt.data.tabstr2struct
%
% Example:
%    a.fielda = 5;
...
%    s = applibt.data.struct2tabstr(a)
%    % convert back
%    a2 = applibt.data.tabstr2struct(s, {'fielda','fieldb'} )
%
