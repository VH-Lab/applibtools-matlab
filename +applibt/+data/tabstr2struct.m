...
%
% A = applibt.data.tabstr2struct(S, FIELDS)
%
...
%
% See also: applibt.file.loadStructArray, applibt.file.saveStructArray, DLMREAD, DLMWRITE, applibt.data.struct2tabstr
%
% Example:
%   s = ['5' char(9) 'my string data'];
%   fn = {'fielda','fieldb'};
%   a = applibt.data.tabstr2struct(s,fn)
% 
