...
%
% NEWRECT = applibt.matlab.graphics.pixels2normalized(FIG, RECT)
%    or
% NEWRECT = applibt.matlab.graphics.pixels2normalized(FIG_RECT, RECT)
%
...
%
% See also:  applibt.matlab.graphics.normalized2pixels
