...
%
% NEWRECT = applibt.matlab.graphics.normalized2pixels(FIG,RECT)
%   or 
% NEWRECT = applibt.matlab.graphics.normalized2pixels(FIG_RECT,RECT)
%
...
%
% See also:  applibt.matlab.graphics.pixels2normalized
