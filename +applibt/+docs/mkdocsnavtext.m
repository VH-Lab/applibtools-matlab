...
% MKDOCSNAVTEXT - create navigation text for mkdoc.yml file from output of applibt.docs.matlab2markdown
%
% T = MKDOCSNAVTEXT(OUT, SPACES)
%
% Given the output structure of applibt.docs.matlab2markdown,
...
for i=1:numel(out),
	...
	if ~isstruct(out(i).path),
		...
		t = cat(2,t,[':' newline]);
		t = cat(2,t,applibt.docs.mkdocsnavtext(out(i).path,spaces+2));	
	end;
end;
