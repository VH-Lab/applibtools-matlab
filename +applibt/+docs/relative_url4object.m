function s = relative_url4object(currentPath, objectName)
% applibt.docs.relative_url4object - compute the relative url name for an object, relative to the current path
%
% S = applibt.docs.relative_url4object(CURRENTPATH, OBJECTNAME)
%
