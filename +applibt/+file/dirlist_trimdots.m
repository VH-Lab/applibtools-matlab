...
%   
%  DIRLIST = applibt.file.dirlist_trimdots(DIRLIST_OR_DIRLISTSTRUCT, [OUTPUT_STRUCT])
%
...
%
%  See also: DIR, applibt.file.dirstrip()
%
%  Example:
%    D=dir
...
%    % now trim
%    dirlist = applibt.file.dirlist_trimdots(dirlist)
%
