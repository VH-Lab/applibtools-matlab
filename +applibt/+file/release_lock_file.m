...
%
% B = applibt.file.release_lock_file(FID_OR_FILENAME, KEY)
%
% Release a lock file given its FID or its FILENAME and the
% correct KEY that was issued by the function applibt.file.checkout_lock_file.
...
%
% See also: applibt.file.checkout_lock_file
% 
% For an example, see applibt.file.checkout_lock_file
% 
...
if numel(C)~=2,
	error([filename ' does not appear to be a lock file created by applibt.file.checkout_lock_file.']);
end;
