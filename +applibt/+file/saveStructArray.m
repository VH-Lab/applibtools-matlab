...
%  
%   applibt.file.saveStructArray(FILENAME, STRUCTARRAY, [HEADER])
%
...
%   applibt.file.loadStructArray).  The input argument HEADER is optional 
...
%
%   See also: applibt.file.loadStructArray, STRUCT, applibt.data.tabstr2struct
%   
...
for i=1:length(gdi)
	s = applibt.data.struct2tabstr(gdi(i));
	fprintf(fid,'%s\n',s);
end
