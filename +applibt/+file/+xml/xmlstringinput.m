...
%   RESULT = applibt.file.xml.xmlstringinput(STRING) will return STRING if
%   it contains "://", indicating that it is a URN.  Otherwise,
%   it will search the path for a file identified by STRING.
%
%   RESULT = applibt.file.xml.xmlstringinput(STRING,FULLSEARCH, RETURNFILE) will
...
%   the full path is built.  If TRUE, the applibt.file.xml.xmlstringinput 
