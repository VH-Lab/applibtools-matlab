...
%
% FULLNAME = applibt.file.fullfilename(FILENAME, [USEWHICH])
%
...
%
% Example:
%   applibt.file.fullfilename('myfile.txt')  % returns [pwd filesep 'myfile.txt']
%   applibt.file.fullfilename('/Users/me/myfile.txt') % returns ['/Users/me/myfile.txt']
%
...
if isempty(foldername),
	...
	if applibt.file.isfilepathroot(foldername), % then we already have full filename
		fullname = filename;
	else,
